...
from canvasapi_async.util import combine_kwargs, is_multivalued, obj_or_id
...
class Group(CanvasObject):
    ...
    def create_membership(self, user, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.group.GroupMembership`
        """
    ...
    def create_page(self, wiki_page, **kwargs):
        ...
        """
        from canvasapi_async.course import Page
    ...
    def get_assignment_override(self, assignment, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.assignment.AssignmentOverride`
        """
        from canvasapi_async.assignment import Assignment, AssignmentOverride
    ...
    def get_memberships(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.group.GroupMembership`
        """
        return PaginatedList(
            GroupMembership,
            self._requester,
    ...
    def get_page(self, url, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.groups.Group`
        """
        from canvasapi_async.course import Page
...
class GroupCategory(CanvasObject):
    ...
    def assign_members(self, sync=False, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of :class:`canvasapi_async.user.User`
            or :class:`canvasapi_async.progress.Progress`
        """
    ...
    def get_groups(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.group.Group`
        """
        return PaginatedList(
