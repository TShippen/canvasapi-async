...
class DiscussionTopic(CanvasObject):
    ...
    def get_entries(self, ids, **kwargs):
        ...
        :type ids: :class:`canvasapi_async.discussion_topic.DiscussionEntry`, or list or tuple of int

        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.discussion_topic.DiscussionEntry`
        """
    ...
    def get_parent(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.group.Group` or :class:`canvasapi_async.course.Course`
        """
    ...
    def post_entry(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.discussion_topic.DiscussionEntry`
        """
        response = self._requester.request(
            "POST",
            "{}s/{}/discussion_topics/{}/entries".format(
