...
from canvasapi_async.util import combine_kwargs, is_multivalued
...
class CustomGradebookColumn(CanvasObject):
    ...
    def get_column_entries(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.custom_gradebook_columns.ColumnData`
        """
...
class ColumnData(CanvasObject):
    ...
    def update_column_data(self, column_data, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.custom_gradebook_columns.ColumnData`
        """
