...
class ContentMigration(CanvasObject):
    ...
    def get_migration_issue(self, migration_issue, **kwargs):
        ...
        :type migration_issue: int, str or :class:`canvasapi_async.content_migration.ContentMigration`

        :rtype: :class:`canvasapi_async.content_migration.MigrationIssue`
        """
        from canvasapi_async.content_migration import MigrationIssue
    ...
    def get_parent(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.group.Account`,
            or :class:`canvasapi_async.course.Course`,
            or :class:`canvasapi_async.course.Group`,
            or :class:`canvasapi_async.course.User`
        """
    ...
    def get_selective_data(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.content_migration.ContentMigrationSelectionNode`
        """
        from canvasapi_async.content_migration import ContentMigrationSelectionNode
