...
class BlueprintTemplate(CanvasObject):
    ...
    def associated_course_migration(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.blueprint.BlueprintMigration`
        """
    ...
    def get_unsynced_changes(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.blueprint.ChangeRecord`
        """
    ...
    def list_blueprint_migrations(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.blueprint.BlueprintMigration`
        """
    ...
    def show_blueprint_migration(self, migration, **kwargs):
        ...
        :type migration: int or :class:`canvasapi_async.blueprint.BlueprintMigration`
