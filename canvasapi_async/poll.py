...
from canvasapi_async.poll_choice import PollChoice
...
class Poll(CanvasObject):
    ...
    def create_choice(self, poll_choice, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.poll_choice.PollChoice`
        """
        if (
    ...
    def create_session(self, poll_session, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.poll_session.PollSession`
        """
        if (
    ...
    def get_choices(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.poll_choice.PollChoice`
        """
    ...
    def get_sessions(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_lsit.Paginated List` of
