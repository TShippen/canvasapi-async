...
class Page(CanvasObject):
    ...
    def get_revision_by_id(self, revision, **kwargs):
        ...
        :type revision: :class:`canvasapi_async.pagerevision.PageRevision` or int

        :returns: Contents of the page revision.
        :rtype: :class:`canvasapi_async.pagerevision.PageRevision`
        """
    ...
    def get_revisions(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.pagerevision.PageRevision`
        """
