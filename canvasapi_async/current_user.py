from canvasapi_async.bookmark import Bookmark
from canvasapi_async.course import Course
from canvasapi_async.favorite import Favorite
...
class CurrentUser(User):
    ...
    def add_favorite_course(self, course, use_sis_id=False, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.favorite.Favorite`
        """
        if use_sis_id:
            course_id = course
    ...
    def create_bookmark(self, name, url, **kwargs):
        ...
        :type url: `str`
        :rtype: :class:`canvasapi_async.bookmark.Bookmark`
        """
        from canvasapi_async.bookmark import Bookmark
    ...
    def get_bookmark(self, bookmark, **kwargs):
        ...
        :type bookmark: :class:`canvasapi_async.bookmark.Bookmark` or int
    ...
    def get_bookmarks(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.bookmark.Bookmark`
        """
