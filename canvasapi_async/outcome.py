...
class OutcomeGroup(CanvasObject):
    ...
    def get_subgroups(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.outcome.OutcomeGroup`
        """
        return PaginatedList(
            OutcomeGroup,
            self._requester,
    ...
    def import_outcome_group(self, outcome_group, **kwargs):
        ...
        :type outcome: :class:`canvasapi_async.outcome.OutcomeGroup` or int
    ...
    def link_existing(self, outcome, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.outcome.OutcomeLink`
        """
