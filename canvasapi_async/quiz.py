...
from canvasapi_async.quiz_group import QuizGroup
...
class Quiz(CanvasObject):
    ...
    def create_question(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.quiz.QuizQuestion`
        """
    ...
    def create_question_group(self, quiz_groups, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.quiz_group.QuizGroup`
        """
    ...
    def create_report(self, report_type, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.quiz.QuizReport`
        """
    ...
    def create_submission(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.quiz.QuizSubmission`
        """
        response = self._requester.request(
            "POST",
    ...
    def get_all_quiz_reports(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.quiz.QuizReport`
        """
    ...
    def get_question(self, question, **kwargs):
        ...
        :type question: int, str or :class:`canvasapi_async.quiz.QuizQuestion`
    ...
    def get_questions(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.quiz.QuizQuestion`
        """
        return PaginatedList(
            QuizQuestion,
            self._requester,
    ...
    def get_quiz_report(self, id, **kwargs):
        ...
        :type id: int or :class:`canvasapi_async.quiz.QuizReport`
    ...
    def get_quiz_submission(self, quiz_submission, **kwargs):
        ...
        :type quiz_submission: int, string, :class:`canvasapi_async.quiz.QuizSubmission`
    ...
    def get_statistics(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.quiz.QuizStatistic`
        """
        return PaginatedList(
            QuizStatistic,
            self._requester,
    ...
    def get_submissions(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.quiz.QuizSubmission`
        """
        return PaginatedList(
            QuizSubmission,
            self._requester,
...
class QuizSubmission(CanvasObject):
    ...
    def answer_submission_questions(self, validation_token=None, **kwargs):
        ...
        :param validation_token: (Optional) The unique validation token for this quiz submission.
            If one is not provided, canvasapi_async will attempt to use `self.validation_token`.
        :type validation_token: str
        :returns: A list of quiz submission questions.
        :rtype: list of :class:`canvasapi_async.quiz.QuizSubmissionQuestion`
        """
        try:
    ...
    def get_submission_events(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
          :class:`canvasapi_async.quiz.QuizSubmissionEvent`
        """
        return PaginatedList(
            QuizSubmissionEvent,
            self._requester,
