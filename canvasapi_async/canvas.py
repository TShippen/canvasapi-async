...
from canvasapi_async.current_user import CurrentUser
...
from canvasapi_async.planner import PlannerNote, PlannerOverride
...
from canvasapi_async.util import combine_kwargs, get_institution_url, obj_or_id
...
class Canvas(object):
    ...
    def create_appointment_group(self, appointment_group, **kwargs):
        ...
        :type title: `str`
        :rtype: :class:`canvasapi_async.appointment_group.AppointmentGroup`
        """
        if (
    ...
    def create_calendar_event(self, calendar_event, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.calendar_event.CalendarEvent`
        """
    ...
    def create_conversation(self, recipients, body, **kwargs):
        ...
        :type body: `str`
        :rtype: list of :class:`canvasapi_async.conversation.Conversation`
        """
    ...
    def create_group(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.group.Group`
        """
        response = self.__requester.request(
    ...
    def create_jwt(self, **kwargs):
        ...
        :rtype: list of :class:`canvasapi_async.jwt.JWT`
        """
        response = self.__requester.request(
    ...
    def create_planner_note(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.planner.PlannerNote`
        """
        response = self.__requester.request(
    ...
    def create_planner_override(self, plannable_type, plannable_id, **kwargs):
        ...
        :type plannable_id: int or :class:`canvasapi_async.planner.PlannerOverride`

        :rtype: :class:`canvasapi_async.planner.PlannerOverride`
        """
    ...
    def create_poll(self, polls, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.poll.Poll`
        """
        if (
    ...
    def get_account(self, account, use_sis_id=False, **kwargs):
        ...
        :type account: int, str or :class:`canvasapi_async.account.Account`
    ...
    def get_appointment_group(self, appointment_group, **kwargs):
        ...
        :type appointment_group: :class:`canvasapi_async.appointment_group.AppointmentGroup` or int
    ...
    def get_appointment_groups(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.appointment_group.AppointmentGroup`
        """
        return PaginatedList(
            AppointmentGroup,
            self.__requester,
    ...
    def get_calendar_event(self, calendar_event, **kwargs):
        ...
        :type calendar_event: :class:`canvasapi_async.calendar_event.CalendarEvent` or int
    ...
    def get_calendar_events(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.calendar_event.CalendarEvent`
        """
        return PaginatedList(
            CalendarEvent,
            self.__requester,
    ...
    def get_comm_messages(self, user, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.comm_message.CommMessage`
    ...
    def get_conversation(self, conversation, **kwargs):
        ...
        :type conversation: :class:`canvasapi_async.conversation.Conversation` or int

        :rtype: :class:`canvasapi_async.conversation.Conversation`
        """
    ...
    def get_conversations(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of \
        :class:`canvasapi_async.conversation.Conversation`
        """
        return PaginatedList(
            Conversation,
            self.__requester,
    ...
    def get_course(self, course, use_sis_id=False, **kwargs):
        ...
        :type course: int, str or :class:`canvasapi_async.course.Course`
    ...
    def get_course_nickname(self, course, **kwargs):
        ...
        :type course: :class:`canvasapi_async.course.Course` or int
    ...
    def get_course_nicknames(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.course.CourseNickname`
        """
        return PaginatedList(
            CourseNickname,
            self.__requester,
    ...
    def get_current_user(self):
        ...
        :rtype: :class:`canvasapi_async.current_user.CurrentUser`
        """
    ...
    def get_eportfolio(self, eportfolio, **kwargs):
        ...
        :type eportfolio: :class: `canvasapi_async.eportfolio.EPortfolio` or int

        :calls: `GET /api/v1/eportfolios/:id` \
            `<https://canvas.instructure.com/doc/api/e_portfolios.html#method.eportfolios_api.show>`_

        :rtype: :class:`canvasapi_async.eportfolio.EPortfolio`
        """
    ...
    def get_epub_exports(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.course_epub_export.CourseEpubExport`
        """
    ...
    def get_group(self, group, use_sis_id=False, **kwargs):
        ...
        :type group: :class:`canvasapi_async.group.Group` or int
    ...
    def get_group_category(self, category, **kwargs):
        ...
        :type category: :class:`canvasapi_async.group.GroupCategory` or int
    ...
    def get_outcome(self, outcome, **kwargs):
        ...
        :type outcome: :class:`canvasapi_async.outcome.Outcome` or int

        :returns: An Outcome object.
        :rtype: :class:`canvasapi_async.outcome.Outcome`
        """
    ...
    def get_planner_note(self, planner_note, **kwargs):
        ...
        :type planner_note: int or :class:`canvasapi_async.planner.PlannerNote`
    ...
    def get_planner_notes(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.planner.PlannerNote`
        """
        return PaginatedList(
            PlannerNote,
            self.__requester,
    ...
    def get_planner_override(self, planner_override, **kwargs):
        ...
        :type planner_override: int or :class:`canvasapi_async.planner.PlannerOverride`
    ...
    def get_planner_overrides(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.planner.PlannerOverride`
        """
        return PaginatedList(
            PlannerOverride,
            self.__requester,
    ...
    def get_polls(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.poll.Poll`
        """
        return PaginatedList(
            Poll,
            self.__requester,
    ...
    def get_progress(self, progress, **kwargs):
        ...
        :type progress: int, str or :class:`canvasapi_async.progress.Progress`
    ...
    def refresh_jwt(self, jwt, **kwargs):
        ...
        :type jwt: str or :class:`canvasapi_async.jwt.JWT`
        :rtype: :class:`canvasapi_async.jwt.JWT`
        """
