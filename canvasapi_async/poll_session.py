...
from canvasapi_async.poll_submission import PollSubmission
...
class PollSession(CanvasObject):
    ...
    def close(self, **kwargs):
        ...
        :returns: :class:`canvasapi_async.poll_session.PollSession`
        """
    ...
    def create_submission(self, poll_submissions, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.poll_submission.PollSubmission`
        """
        if (
    ...
    def get_submission(self, poll_submission, **kwargs):
        ...
        :type poll_submission: int or :class:`canvasapi_async.poll_submission.PollSubmission`
