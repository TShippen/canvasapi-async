...
from canvasapi_async.util import combine_kwargs, obj_or_id, obj_or_str
...
class User(CanvasObject):
    ...
    def create_communication_channel(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.communication_channel.CommunicationChannel`
        """
        response = self._requester.request(
            "POST",
    ...
    def create_pairing_code(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.pairing_code.PairingCode`
        """
    ...
    def get_avatars(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.avatar.Avatar`
        """
        return PaginatedList(
            Avatar,
            self._requester,
    ...
    def get_closed_poll_sessions(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.poll_session.PollSession`
        """
    ...
    def get_communication_channels(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.communication_channel.CommunicationChannel`
        """
        return PaginatedList(
    ...
    def get_eportfolios(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.eportfolio.EPortfolio`
        """
    ...
    def get_page_views(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.course.PageView`
        """
        return PaginatedList(
            PageView,
            self._requester,
    ...
    def merge_into(self, destination_user, **kwargs):
        ...
        :type destination_user: :class:`canvasapi_async.user.User` or int
