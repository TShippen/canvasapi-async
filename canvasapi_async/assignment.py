...
from canvasapi_async.submission import Submission
from canvasapi_async.upload import FileOrPathLike, Uploader
from canvasapi_async.user import User, UserDisplay
from canvasapi_async.util import combine_kwargs, obj_or_id
...
class Assignment(CanvasObject):
    ...
    def get_gradeable_students(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.user.UserDisplay`
        """
        return PaginatedList(
            UserDisplay,
            self._requester,
    ...
    def get_override(self, override, **kwargs):
        ...
        :type override: :class:`canvasapi_async.assignment.AssignmentOverride` or int
    ...
    def get_peer_reviews(self, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.paginated_list.PaginatedList` of
            :class:`canvasapi_async.peer_review.PeerReview`
        """
        return PaginatedList(
            PeerReview,
            self._requester,
    ...
    def get_provisional_grades_status(self, student_id, **kwargs):
        ...
        :type student_id: :class:`canvasapi_async.user.User` or int
    ...
    def get_submission(self, user, **kwargs):
        ...
        :rtype: :class:`canvasapi_async.submission.Submission`
        """
    ...
    def set_extensions(self, assignment_extensions, **kwargs):
        ...
        :rtype: list of :class:`canvasapi_async.assignment.AssignmentExtension`
    ...
    def show_provisonal_grades_for_student(self, anonymous_id, **kwargs):
        ...
        :type anonymous_id: :class:`canvasapi_async.user.User` or int
    ...
    def upload_to_submission(self, file: FileOrPathLike, user="self", **kwargs):
        ...
        :type user: :class:`canvasapi_async.user.User`, int, or str
